...
<br>
<br>
Также в ходе тестирования было обнаружено, что все три системы могут получить деление на 0 при некоторых ситуациях (например, в 11-ом тесте все три системы выдали nan),
...
<h4>6. Два отрезка коллинеарны и при этом накладываются друг на друга</h4>
...
<h4>8. Два отрезка коллиняарны и не накладываются друг на друга</h4>
